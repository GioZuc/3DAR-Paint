...
class StrokeColor {
  ...
  static const StrokeColor red     = StrokeColor(1.0, 0.2, 0.2);
  static const StrokeColor green   = StrokeColor(0.2, 1.0, 0.4);
  static const StrokeColor yellow  = StrokeColor(1.0, 0.9, 0.0);
  static const StrokeColor white   = StrokeColor(1.0, 1.0, 1.0);
  static const StrokeColor magenta = StrokeColor(1.0, 0.0, 1.0);
